...
## 2. Responsive vertex label handling (Completed)
- [x] Improve visual handling of vertices with long labels.
- [x] Adapt node outline frames or boundaries to dynamically size with text length to prevent text overflow or word cutting.
- [x] Ensure that dynamic node sizing plays nicely with layout calculations (repulsion radius, hub curves, bounding box calculations).
- [x] Wrap long names elegantly and keep the layout neat and legible.
